/*
// $Id: XmlaOlap4jConcurrentMemoryCache.java 92 2008-07-17 07:41:10Z lucboudreau $
 ...
 * @author Luc Boudreau
 * @version $Id: XmlaOlap4jConcurrentMemoryCache.java 92 2008-07-17 07:41:10Z lucboudreau $
 */
    ...
    public byte[] get(final URL url, final byte[] request) {
        ...
        synchronized (this.cacheEntries) {
            ...
            XmlaOlap4jCacheElement entry = this.cacheEntries.get( 
                XmlaOlap4jSHAEncoder.SHA1( url.toExternalForm() 
                        + new String(request) ) );
